...
| [web-design](https://github.com/KAOPU-XiaoPu/web-design) | 设计美观、一致的网页。专注页面整体设计、有主见的美学。 | Community | ⭐544 |
| [ai-friendly-web-design-skill](https://github.com/ianho7/ai-friendly-web-design-skill) | 构建对 AI 助手和用户都友好的 web 界面——结构、语义、可访问性为 AI 消费调优。 | Community | ⭐61 |
...
| [material-3-skill](https://github.com/hamen/material-3-skill) | 实现 Google Material Design 3（Material You）。主攻 Jetpack Compose + Flutter，web 有限。30+ 组件、主题、动态配色。 | Community | ⭐1025 |
...
| [getdesign](https://github.com/MohtashamMurshid/getdesign) | 从任意 URL 即时提取设计系统。五个面、一个 agent——把线上站点变可复用 DS。 | Community | ⭐35 |
...
| [frontend-slides](https://github.com/zarazhangrui/frontend-slides) | 从零或转换 PowerPoint 创建动画丰富的 HTML 演示。含 bold 模板包。 | Community | ⭐22552 |
...
| Skill | 说明 | 来源 | 星数 |
|---|---|---|---|
| [taste-skill](https://github.com/senlindesign/taste-skill) | 从 URL 逆向任意网站的设计品味。抓取 DOM+截图，产出 token 和品味 DNA（决策背后的 why）。 | Community | ⭐167 |
...
| [SwiftUI-Agent-Skill](https://github.com/twostraws/SwiftUI-Agent-Skill) | Paul Hudson 的 SwiftUI agent skill。帮 AI 写更聪明的现代 SwiftUI——API、设计、性能、可访问性、导航。 | Community | ⭐4160 |
...
| [ios-simulator-skill](https://github.com/conorluddy/ios-simulator-skill) | iOS 模拟器自动化——构建/测试脚本、可访问性导航、屏幕映射、手势、视觉 diff、app 生命周期。 | Community | ⭐1103 |
